...
def random_component_by_score(component_type, component_map): 
    ...
    # Get all the valid component names from component map 
    names = component_map.keys()
    # Loop over valid names and use them to calculate the average score for each 
    ...
    for name, score in avg_scores.items(): 
        cumulative += score
        # the higher the score, the higher the chance of being picked 
...
def score_conversation(
    ...
    # hash, key to look at, putting in the score 
